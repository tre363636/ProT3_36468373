...
<section class="my-4">
        <div class="container">
            <div class="rounded-container">
                <h2>Historia de Mapaches Antifaces</h2>
                <p>Mapaches Antifaces surgió de la pasión por los animales y la creatividad de nuestros fundadores, quienes vieron una oportunidad única de combinar ambos mundos en un solo producto. Desde nuestros inicios, nos hemos dedicado a ofrecer mapaches con personalidades y estilos únicos, brindando alegría y entretenimiento a nuestros clientes.</p>
